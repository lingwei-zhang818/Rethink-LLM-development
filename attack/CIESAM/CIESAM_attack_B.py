...
MODEL_PATH = './CIESAM/ecthr_b/nlpaueb/legal-bert-base-uncased/seed_4'
...
np.save('./attack/CIESAM/ecthr_graph_true_B.npy', y)
np.save('./attack/CIESAM/ecthr_graph_pred_B.npy', prediction)
np.save('./attack/CIESAM/ecthr_graph_attack_B.npy', results)
