...
MODEL_PATH = './CASAM/ecthr_a/nlpaueb/legal-bert-base-uncased/0.000015/seed_1'
...
np.save('./attack/CASAM/ecthr_graph_true_A.npy', y)
np.save('./attack/CASAM/ecthr_graph_pred_A.npy', prediction)
np.save('./attack/CASAM/ecthr_graph_attack_A.npy', results)