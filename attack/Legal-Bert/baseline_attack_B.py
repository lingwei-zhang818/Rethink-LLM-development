...
MODEL_PATH = './Legal-Bert/nlpaueb/legal-bert-base-uncased/ecthr_b/seed_4'
...
np.save('./attack/Legal-Bert/ecthr_graph_true_B.npy', y)
np.save('./attack/Legal-Bert/ecthr_graph_pred_B.npy', prediction)
np.save('./attack/Legal-Bert/ecthr_graph_attack_B.npy', results)
